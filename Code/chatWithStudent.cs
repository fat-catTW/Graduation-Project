...
public class chatWithStudent : MonoBehaviour
{
    ...
    private void HandleStudentResponse(string responseText)
    {
        ...
        {
            case 0:
                studentSpeakText1.gameObject.SetActive(true);
                studentSpeakText1.text = response.message;
                studentSpeakText2.gameObject.SetActive(false);
                studentSpeakText3.gameObject.SetActive(false);
                break;
            case 1:
                studentSpeakText2.gameObject.SetActive(true);
                studentSpeakText2.text = response.message;
                studentSpeakText1.gameObject.SetActive(false);
                studentSpeakText3.gameObject.SetActive(false);
                break;
            case 2:
                studentSpeakText3.gameObject.SetActive(true);
                studentSpeakText3.text = response.message;
                studentSpeakText1.gameObject.SetActive(false);
                studentSpeakText2.gameObject.SetActive(false);
                break;
        }
    ...
    void progressUpdate(int progress)
    {
        if(progress <= childCount)
        {
            ...
            StartCoroutine(sendProgressUpdate(CurrentCourseId, "one_to_three", progress));
        }
